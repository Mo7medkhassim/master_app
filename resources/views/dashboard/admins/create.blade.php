                                        ...
                                        <div class="tab-pane fade {{ $index == 0 ? ' show active' : '' }}" id="{{ $model }}">
                                            <div class="d-flex  res_flex">
                                                ...
                                                <label class="form-check mt-1 mr-3">
                                                    <input type="checkbox" name="permissions[]" value="{{ $model }}_create" class="form-check-input">
                                                    <span class="form-check-label">create</span>
                                                </label>

                                                <label class="form-check mr-3">
                                                    <input type="checkbox" name="permissions[]" value="{{ $model }}_read" class="form-check-input">
                                                    <span class="form-check-label">read</span>
                                                </label>

                                                <label class="form-check mr-3">
                                                    <input type="checkbox" name="permissions[]" value="{{ $model }}_update" class="form-check-input">
                                                    <span class="form-check-label">update</span>
                                                </label>

                                                <label class="form-check ">
                                                    <input type="checkbox" name="permissions[]" value="{{ $model }}_delete" class="form-check-input">
